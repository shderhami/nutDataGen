...
- generated: 2026-08-17  |  spec: `data/intake/chicken_thigh_skinless.json`
...
| nutrient | unit | FND | SR | AFCD | BLS | CIQUAL | CoFID | FCDB | IodineDB | MEXT | verdict |
|---|---|---|---|---|---|---|---|---|---|---|---|
...
| Selenium (1103) | µg | — | 22.9 (n=5) | 21 | — | — | 14° | 12.4 (n=28) | — | 19 | **confirm** |
...
| Pantothenic acid (1170) | mg | — | — | 0.95 | 1.06† | 1.2° / 1.23≈ | 1.09° | 1.058† | — | 1.06 | **adopt_foreign** |
| Pyridoxine (1175) | mg | — | 0.451 (n=5) | 0.24 | 0.42† | 0.35° / 0.45≈ | 0.28° | 0.39 (n=20) | — | 0.31 | **confirm** |
| Folic acid (1177) | µg | — | 4† | 32 | 11† | 7.67° / 4≈ | 9° | 21.1667 (n=24) | — | 10 | **review** |
...
- no USDA value; 4 independent(s) available
- suggestion: 1.09 mg (source `literature`)
...
- all 5 independent(s) differ >±20% from sr_legacy 4: FCDB 21.1667 (n=24), MEXT 10, CIQUAL 7.67, AFCD 32, CoFID 9
